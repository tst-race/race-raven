...
formatlog "INFO" "Starting email server"
formatlog "WARNING" "All email channels use the same whiteboard, please only start one"
docker-compose -p raven-services -f "${BASE_DIR}/docker-compose.yml" up -d
