...
formatlog "INFO" "All raven Channels use these services. Stopping one of the services stops them all"
docker-compose -p raven-services -f "${BASE_DIR}/docker-compose.yml" stop
docker-compose -p raven-services -f "${BASE_DIR}/docker-compose.yml" down
